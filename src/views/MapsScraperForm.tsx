      ...
      {viewMode === 'scraping' && (
        <section className="bg-slate-800 rounded shadow p-6">
          ...
          <h2 className="text-lg mb-4">
            Questo strumento consente di cercare e scaricare dati da Google Maps in formato CSV. Inserisci le query di ricerca, scegli la cartella di destinazione, configura l'uso di proxy e modalità bot, quindi avvia o interrompi la raccolta dati.
          </h2>
          <input
            type="text"
